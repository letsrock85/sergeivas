...
const require$1 = createRequire(__filename), groqTagName = "groq", defaultBabelOptions$2 = {
...
const debug = createDebug("sanity:codegen:findQueries:debug"), defaultBabelOptions$1 = {
  extends: join(__dirname, "..", "..", "babel.config.json")
};
