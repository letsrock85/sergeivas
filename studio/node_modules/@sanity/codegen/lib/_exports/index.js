...
var promises = require("fs/promises"), json5 = require("json5"), z = require("zod"), groqJs = require("groq-js"), fs$1 = require("node:fs/promises"), path = require("node:path"), createDebug = require("debug"), glob = require("globby"), node_module = require("node:module"), core = require("@babel/core"), t = require("@babel/types"), fs = require("node:fs"), traverse = require("@babel/traverse"), tsconfigPaths = require("tsconfig-paths"), register = require("@babel/register"), generator = require("@babel/generator");
...
const require$1 = node_module.createRequire(__filename), groqTagName = "groq", defaultBabelOptions$2 = {
  extends: path.join(__dirname, "..", "..", "babel.config.json")
};
function findQueriesInSource(source, filename, babelConfig = defaultBabelOptions$2, resolver = require$1.resolve) {
...
const debug = createDebug__default.default("sanity:codegen:findQueries:debug"), defaultBabelOptions$1 = {
  extends: path.join(__dirname, "..", "..", "babel.config.json")
};
async function* findQueriesInPath({
  path: path2,
  babelOptions = defaultBabelOptions$1,
...
function registerBabel(babelOptions = defaultBabelOptions) {
  register__default.default({ ...babelOptions, extensions: [".ts", ".tsx", ".js", ".jsx"] });
}
const REFERENCE_SYMBOL_NAME = "internalGroqTypeReferenceTo";
class TypeGenerator {
  constructor(schema) {
    this.generatedTypeName = /* @__PURE__ */ new Set(), this.typeNameMap = /* @__PURE__ */ new Map(), this.schema = schema;
  }
  /**
