...
class ArrayWrapper {
  constructor(value, annotation) {
    this.type = "array", this.elements = [], this.annotation = annotation, this.value = value, this.length = value.length;
  }
  at(idx) {
    if (idx >= this.length)
...
class ObjectWrapper {
  constructor(value, annotation) {
    this.type = "object", this.fields = {}, this.value = value, this.annotation = annotation, this.keys = Object.keys(value);
  }
  get(key) {
...
class StringWrapper {
  constructor(value, annotation) {
    this.type = "string", this.value = value, this.annotation = annotation;
  }
