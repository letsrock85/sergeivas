...
var paths = require("@sanity/util/paths"), arrify = require("arrify"), mutiny = require("@bjoerge/mutiny"), promises = require("node:fs/promises"), createDebug = require("debug"), FIFO = require("fast-fifo"), createSafeJsonParser = require("@sanity/util/createSafeJsonParser"), groq = require("groq-js"), client$1 = require("@sanity/client"), client = require("@sanity/util/client"), node_os = require("node:os"), path = require("node:path");
function _interopDefaultCompat(e) {
  return e && typeof e == "object" && "default" in e ? e : { default: e };
}
var arrify__default = /* @__PURE__ */ _interopDefaultCompat(arrify), createDebug__default = /* @__PURE__ */ _interopDefaultCompat(createDebug), FIFO__default = /* @__PURE__ */ _interopDefaultCompat(FIFO), groq__default = /* @__PURE__ */ _interopDefaultCompat(groq), path__default = /* @__PURE__ */ _interopDefaultCompat(path);
...
function parseGroqFilter(filter2) {
  try {
    return groq__default.default.parse(`*[${filter2}]`);
  } catch (err) {
    throw err.message = `Failed to parse GROQ filter "${filter2}": ${err.message}`, err;
  }
}
async function matchesFilter(parsedFilter, document) {
  return (await (await groq__default.default.evaluate(parsedFilter, { dataset: [document] })).get()).length === 1;
}
