...
var isEqual = require("lodash/isEqual.js"), debugIt = require("debug"), compact = require("lodash/compact.js"), flatten = require("lodash/flatten.js"), diffMatchPatch = require("@sanity/diff-match-patch"), max = require("lodash/max.js"), min = require("lodash/min.js"), uuid = require("@sanity/uuid");
function _interopDefaultCompat(e) {
  return e && typeof e == "object" && "default" in e ? e : { default: e };
}
var isEqual__default = /* @__PURE__ */ _interopDefaultCompat(isEqual), debugIt__default = /* @__PURE__ */ _interopDefaultCompat(debugIt), compact__default = /* @__PURE__ */ _interopDefaultCompat(compact), flatten__default = /* @__PURE__ */ _interopDefaultCompat(flatten), max__default = /* @__PURE__ */ _interopDefaultCompat(max), min__default = /* @__PURE__ */ _interopDefaultCompat(min);
...
class Document {
  constructor(doc) {
    this.incoming = [], this.submitted = [], this.pending = [], this.inconsistentAt = null, this.lastStagedAt = null, this.reset(doc), this.HEAD = doc, this.EDGE = doc;
  }
...
class SquashingBuffer {
  constructor(doc) {
    this.out = [], doc ? debug("Reset mutation buffer to rev %s", doc._rev) : debug("Reset mutation buffer state to document being deleted"), this.staged = [], this.setOperations = {}, this.documentPresent = !1, this.BASIS = doc, this.PRESTAGE = doc;
  }
  add(mut) {
...
class BufferedDocument {
  constructor(doc) {
    this.committerRunning = !1, this.buffer = new SquashingBuffer(doc), this.document = new Document(doc), this.document.onMutation = (msg) => this.handleDocMutation(msg), this.document.onRemoteMutation = (mut) => this.onRemoteMutation && this.onRemoteMutation(mut), this.document.onRebase = (edge, remoteMutations, localMutations) => this.handleDocRebase(edge, remoteMutations, localMutations), this.document.onConsistencyChanged = (msg) => this.handleDocConsistencyChanged(msg), this.LOCAL = doc, this.mutations = [], this.commits = [];
  }
