...
`, DefaultListItemInner = styled__default.default.div``;
...
function createWithHotkeys(types$1, keyGenerator, portableTextEditor, hotkeysFromOptions) {
  ...
  return function(editor) {
    return editor.pteWithHotKeys = (event) => {
      ...
      const isEnter = isHotkey__default.default("enter", event.nativeEvent), isTab = isHotkey__default.default("tab", event.nativeEvent), isShiftEnter = isHotkey__default.default("shift+enter", event.nativeEvent), isShiftTab = isHotkey__default.default("shift+tab", event.nativeEvent), isBackspace = isHotkey__default.default("backspace", event.nativeEvent), isDelete = isHotkey__default.default("delete", event.nativeEvent);
...
`);
      ...
      (isHotkey__default.default("mod+y", event.nativeEvent) || isHotkey__default.default("mod+shift+z", event.nativeEvent)) && (event.preventDefault(), editor.redo());
    }, editor;
  };
}
...
class PortableTextEditor extends react.Component {
  constructor(props) {
    if (super(props), this.change$ = new rxjs.Subject(), this.setEditable = (editable) => {
...
PortableTextEditor.activeAnnotations = (editor) => editor && editor.editable ? editor.editable.activeAnnotations() : [], PortableTextEditor.addAnnotation = (editor, type, value) => {
  var _a;
...
}, PortableTextEditor.getSelection = (editor) => editor.editable ? editor.editable.getSelection() : null, PortableTextEditor.getValue = (editor) => {
  var _a;
