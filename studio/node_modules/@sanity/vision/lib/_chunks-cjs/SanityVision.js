"use strict";
var jsxRuntime = require("react/jsx-runtime"), sanity = require("sanity"), ui = require("@sanity/ui"), react = require("react"), SplitPane = require("@rexxars/react-split-pane"), icons = require("@sanity/icons"), isHotkey = require("is-hotkey"), CodeMirror = require("@uiw/react-codemirror"), autocomplete = require("@codemirror/autocomplete"), commands = require("@codemirror/commands"), langJavascript = require("@codemirror/lang-javascript"), language = require("@codemirror/language"), search = require("@codemirror/search"), view = require("@codemirror/view"), highlight = require("@lezer/highlight"), color = require("@sanity/color"), styled = require("styled-components"), resizeObserver = require("@juggle/resize-observer"), JSON5 = require("json5"), debounce = require("lodash/debounce.js"), index = require("./index.js"), JSONInspector = require("@rexxars/react-json-inspector"), HLRU = require("hashlru");
function _interopDefaultCompat(e) {
  return e && typeof e == "object" && "default" in e ? e : { default: e };
}
var SplitPane__default = /* @__PURE__ */ _interopDefaultCompat(SplitPane), isHotkey__default = /* @__PURE__ */ _interopDefaultCompat(isHotkey), CodeMirror__default = /* @__PURE__ */ _interopDefaultCompat(CodeMirror), styled__default = /* @__PURE__ */ _interopDefaultCompat(styled), JSON5__default = /* @__PURE__ */ _interopDefaultCompat(JSON5), debounce__default = /* @__PURE__ */ _interopDefaultCompat(debounce), JSONInspector__default = /* @__PURE__ */ _interopDefaultCompat(JSONInspector), HLRU__default = /* @__PURE__ */ _interopDefaultCompat(HLRU);
...
const PerspectivePopoverContent = styled__default.default(ui.Box)`
  /* This limits the width of the popover content */
  max-width: 240px;
`, PerspectivePopoverLink = styled__default.default.a`
  cursor: pointer;
  margin-right: auto;
`;
...
const ErrorCode = styled__default.default(ui.Code)`
...
const ResultViewWrapper = styled__default.default.div(({ theme }) => {
...
const Header = styled__default.default(ui.Card)`
  border-bottom: 1px solid var(--card-border-color);
`, StyledLabel = styled__default.default(ui.Label)`
  flex: 1;
`, SplitpaneContainer = styled__default.default(ui.Box)`
  position: relative;
`, QueryCopyLink = styled__default.default.a`
  cursor: pointer;
  margin-right: auto;
`, InputBackgroundContainer = styled__default.default(ui.Box)`
  position: absolute;
  top: 1rem;
  left: 0;
  padding: 0;
...
`, InputBackgroundContainerLeft = styled__default.default(InputBackgroundContainer)`
  // This is so its aligned with the gutters of CodeMirror
  left: 33px;
`, InputContainer = styled__default.default(ui.Card)`
  width: 100%;
  height: 100%;
  position: relative;
  flex-direction: column;
`, ResultOuterContainer = styled__default.default(ui.Flex)`
  height: 100%;
`, ResultInnerContainer = styled__default.default(ui.Box)`
  position: relative;
`, ResultContainer = styled__default.default(ui.Card)`
  height: 100%;
  width: 100%;
  position: absolute;
  max-width: 100%;

  ${({ $isInvalid }) => $isInvalid && styled.css`
      &:after {
    ...
    `}
`, Result = styled__default.default(ui.Box)`
  position: relative;
  width: 100%;
  height: 100%;
  z-index: 20;
`, TimingsFooter = styled__default.default(ui.Box)`
  border-top: 1px solid var(--card-border-color);
`, TimingsCard = styled__default.default(ui.Card)`
  position: relative;
`;
styled__default.default(ui.Box)`
  width: 100%;
  height: 100%;
`;
const TimingsTextContainer = styled__default.default(ui.Flex)`
  height: 100%;
...
`, ControlsContainer = styled__default.default(ui.Box)`
  border-top: 1px solid var(--card-border-color);
`;
function nodeContains(node, other) {
  return !node || !other ? !1 : node === other || !!(node.compareDocumentPosition(other) & 16);
}
const sanityUrl = /\.(?:api|apicdn)\.sanity\.io\/(vX|v1|v\d{4}-\d\d-\d\d)\/.*?(?:query|listen)\/(.*?)\?(.*)/, isRunHotkey = (event) => isHotkey__default.default("ctrl+enter", event) || isHotkey__default.default("mod+enter", event);
...
class VisionErrorBoundary extends react.Component {
  constructor(props) {
    super(props), this.handleRetryRender = () => this.setState((prev) => ({ error: null, numRetries: prev.numRetries + 1 })), this.handleRetryWithCacheClear = () => {
