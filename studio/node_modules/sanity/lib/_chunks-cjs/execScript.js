"use strict";
var child_process = require("child_process"), fs = require("fs/promises"), path = require("path"), readPkgUp = require("read-pkg-up"), helpers = require("yargs/helpers"), yargs = require("yargs/yargs");
...
const execScript = async function(args, context) {
  ...
  child_process.spawn(process.argv[0], nodeArgs, {
    stdio: "inherit",
    env: {
