"use strict";
var logSymbols = require("log-symbols"), path = require("path"), readPkgUp = require("read-pkg-up"), worker_threads = require("worker_threads"), chalk = require("chalk"), tty = require("tty");
function _interopDefaultCompat(e) {
  return e && typeof e == "object" && "default" in e ? e : { default: e };
}
var logSymbols__default = /* @__PURE__ */ _interopDefaultCompat(logSymbols), path__default = /* @__PURE__ */ _interopDefaultCompat(path), readPkgUp__default = /* @__PURE__ */ _interopDefaultCompat(readPkgUp), chalk__default = /* @__PURE__ */ _interopDefaultCompat(chalk);
const isTty = tty.isatty(1), headers = {
