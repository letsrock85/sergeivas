...
import { b as buildStaticFiles } from "./previewServer.js";
import "vite";
import "./runtime.js";
...
}), rimraf = promisify(rimraf$1);
async function buildSanityStudio(args, context, overrides) {
  var _a;
  const timer = getTimer(), { output, prompt, workDir, cliConfig, telemetry = noopLogger } = context, flags = {
    minify: !0,
    stats: !1,
    "source-maps": !1,
    ...args.extOptions
  ...
  if (await checkStudioDependencyVersions(workDir), (await checkRequiredDependencies(context)).didInstall)
    return { didCompile: !1 };
